MEMORY {
  str              : ORIGIN = 0x0000, LENGTH = 0x0010 /* END=0x0010, size 16 */
  ...
  storage (w)      : ORIGIN = 0xc000, LENGTH = 0x0200 /* END=0xc200, size 512 */
  rom (rx)         : ORIGIN = 0xc200, LENGTH = 0x3fe0 /* END=0xffe0, size 16352 */
